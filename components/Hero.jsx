...
function Hero() {
  return (
    <div className="h-screen w-full bg-white dark:bg-black" id='home'>
      ...
      <section className="justify-center content-center z-50">
        <div className="mx-auto max-w-screen-xl px-4 py-28 lg:flex lg:h-screen lg:items-center text-black dark:text-white">
          <motion.div
